...
Initiative: **Master Security Controls**
...
Hence, mastering security controls has been successful if we either ```learn how to do it properly``` or we ```succeed in understanding it completely```. 
